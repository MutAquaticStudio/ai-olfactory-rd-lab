...
async function mockApi(page: Page) {
  await page.route('**/api/v1/meta', (route) => route.fulfill({ json: { label_names: ['floral', 'jasmine', 'musk', 'woody'], taxonomy_version: '1.2', projection_name: 'Osmo-compatible projection', generation_limits: { required_candidates: 5, shortlist_count: 3, max_attempts: 200, max_seconds: 120, max_event_lines: 30, candidate_stereo_limit: 4, max_target_descriptors: 3, target_score_pool_size: 64 }, target_matching: { requested_target_floor: 0.3, requested_fit_floor: 0.4, relaxation_step: 0.05, policy: 'TEST', descriptors: ['floral', 'jasmine', 'musk', 'woody'].map((name) => ({ name, positive_support: 20, assessed_negative_support: 0, maturity: 'LIMITED_EVIDENCE', decision_threshold: 0.2, calibration_method: 'rare_tier_platt', selectable: true })) }, conformer_ensemble: { normal_sampling_count: 50, macrocycle_sampling_count: 100, max_displayed: 5, normal_cluster_rmsd: 0.75, macrocycle_cluster_rmsd: 1, cache_size: 128 }, stereo: { analysis_option_limit: 16, candidate_variant_limit: 4 }, capabilities: { structure_2d: true, conformer_3d: true }, data_foundation: { available: true, label_semantics: ['PRESENT', 'ABSENT', 'UNASSESSED'], intensity_scale: [0, 10] }, reference_verification: referenceMeta, models: { judge: { model_version: 'judge-v1-legacy' }, creator: { model_version: 'creator-v1-legacy' } } } }));
